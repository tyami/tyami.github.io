...
ID3 알고리즘에서는 분기 전후의 엔트로피를 기반으로 Information Gain을 계산하고, 이를 최대화하는 방향으로 지표를 정했습니다.
하지만 Information Gain에는 한계점이 존재합니다.
...
다른 지표인 With whom? 이라는 지표로 분기했을 때는 Information Gain이 0.6813이 나옵니다.
\begin{aligned}
...
![IG의 한계점 - 예시 1]({{ site.url }}{{ site.baseurl }}/assets/images/post/ML/2020-10-04-IG-limitation-example1.png)
위의 예시에서 Windy 지표에 대한 Information Gain Ratio를 계산해보면, 첫 번째 경우는 0.5739라는 값을 얻을 수 있습니다.
\begin{aligned}
...
![IG의 한계점 - 예시 2]({{ site.url }}{{ site.baseurl }}/assets/images/post/ML/2020-10-04-IG-limitation-example2.png)
두 번째 예시의 경우, 동일한 방법으로 With whom에 대한 GR을 계산하면 0.2182라는 값을 얻습니다.
\begin{aligned}
Information Gain Ratio&=IG/IV \\\\\\
&=\frac{0.6813}{3.1219} \\\\\\
&=0.2182
