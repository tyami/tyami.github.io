...
이전 글 보기: [의사결정 나무 (Decision Tree) 기본 설명]({{ site.url }}{{ site.baseurl }}/machine%20learning/decision-tree-1-concept/)
...
다음 글 보기: [의사결정 나무 (Decision Tree) C4.5 알고리즘 설명]({{ site.url }}{{ site.baseurl }}/machine%20learning/decision-tree-3-c4_5/)